            ...
            <div class="cs-auth-form w-full max-w-sm mx-auto">
                ...
                ${social ? html`
                    <div class="flex flex-col gap-2 mb-4">
                        <button type="button" class="w-full flex items-center justify-center gap-2 h-10 px-4 rounded-md border border-input bg-background shadow-xs text-sm font-medium text-foreground hover:bg-accent hover:text-accent-foreground cursor-pointer transition-colors outline-none focus-visible:ring-ring/50 focus-visible:ring-[3px]"
