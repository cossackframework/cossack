        ...
        return html`
            <div class="flex flex-col items-center justify-center min-h-[70vh] gap-8 px-4">
                <div class="text-center space-y-4">
                    <h1 class="text-5xl font-bold text-gray-900 tracking-tight">Hello Cossack!</h1>
                    <p class="text-lg text-gray-500">A modern full-stack TypeScript framework</p>
                </div>

                <div class="flex items-center gap-4 bg-white rounded-xl shadow-sm border border-gray-200 px-8 py-6">
                    <span class="text-sm font-medium text-gray-500 uppercase tracking-wide">Count</span>
